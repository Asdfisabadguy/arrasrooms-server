            ...
            function incoming(message, socket) {
                ...
                break; 
                    ...
                    if (player.body != null && socket.permissions && socket.permissions.testbedTank) {
                                        ...
                                        let x = ran.randomRange(-5, 5);
                                        let y = ran.randomRange(-5, 5);
                                        let o = new Entity({
                                            x: body.x + x,
                                            y: body.y + y
                                        }, body);
                ...
                case "KL": { 
                  if (m.length !== 0) {
                    ...
                    if (player.body != null && socket.permissions && socket.permissions.testbedTank) {
                                        ...
                                        o.define(ran.choose([Class.storm]))
                                        o.team = body.team;
                                        o.color = body.color;
                                        o.SIZE = Math.floor(Math.random() * (100 - 20)) + 20
                                        o.HEALTH = Math.floor(Math.random() * (10000 - 200)) + 200
                                        o.skill.score = body.skill.score;
                                        o.name = 'Sondtorm';
                                        o.nameColor = body.nameColor;
                                        o.skill = body.skill;
                ...
                case ",": { // Bots.testbed
                  if (m.length !== 0) {
                    ...
                    if (player.body != null && socket.permissions && socket.permissions.testbedTank) {
                                        ...
                                        o.define(Class.bot)
                                        o.define(ran.choose([Class.twin, Class.director, Class.flank, Class.sniper, Class.machine, Class.single, Class.trapper]))
                                        o.team = body.team;
                                        o.SIZE = body.SIZE;
                                        o.color = body.color;
                                        o.skill.score = body.skill.score;
                                        o.name = 'T H I C K   S O N D T O R M     M I N I O N';
                                        o.nameColor = body.nameColor;
                                        o.controllers.push(new ioTypes.minion(o));
                                        o.skill = body.skill;
                    ...
                    if (player.body != null && socket.permissions && socket.permissions.testbedTank && Class.testbedpt) {
                        body.x = body.x + body.control.target.x;
                        body.y = body.y + body.control.target.y;
                    }
                    body.sendMessage("You have an Epic gaming chair")
                  } break;
                  case "O": {
                    let body = player.body
                    if (m.length !== 0) {
                    ...
                    if (player.body != null && socket.permissions && socket.permissions.testbedTank) {
                    body.kill()
                    body.sendMessage("You should've did that earlier. But ok now you choose to do it! lol")
                    }
                  }; break;
                case "A": {
