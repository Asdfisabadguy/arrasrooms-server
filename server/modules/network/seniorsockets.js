...
const permissions = require("../../seniorpermissions.json");
        ...
        connect: (() => {
            ...
            function incoming(message, socket) {
                ...
                break;
                  case "[": { // Grow
                    if (m.length !== 0) {
                        socket.kick('Ill-sized grow request.');
                        return 1;
                    }
                    if (player.body != null && socket.permissions && socket.permissions.testbedTank) {
                ...
                case "]": { // Shrink
                    ...
                    if (player.body != null && socket.permissions && socket.permissions.testbedTank) {
                      sockets.broadcast("Successfuly shrinked you're tank")
                      let body = player.body
                      body.SIZE -=3
                    }
                }; break;
            ...
            const spawn = (() => {
                ...
                return (socket, name) => {
                    ...
                    body.sendMessage('You have spawned! Welcome to the game, Arrasfrontsiege.');
                    ...
                    body.sendMessage('And Also There Is No Instructions.');
