    ...
    const gameDraw = (() => {
        ...
        return (ratio, drawRatio) => {
            ...
            let max = lb.max; {
                ...
                // Text
                if (global.showDebug) {
                    text.debug[5].draw('arrasfrontsiege.glitch.me', x + len, y - 50 - (5 * 14) - 2, 15, "#FF7700", 'right');
                    ...
                    text.debug[2].draw('arrasfrontsiege.glitch.me', x + len, y - 50 - (2 * 14) - 2, 15, "#FF7700", 'right');
                    text.debug[1].draw((100 * gui.fps).toFixed(2) + '% : ' + global.metrics.rendertime + " FPS", x + len, y - 50 - 1 * 14, 10, global.metrics.rendertime > 10 ? color.guiwhite : color.orange, 'right');
